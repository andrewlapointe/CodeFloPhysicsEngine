class QuadTree:
    ...
    def query_radius(self, centre, radius, found_points):
        ...
        return self.query_circle(boundary, centre, radius, found_points) or []
...
class Rect:
    ...
    See: https://scipython.com/blog/quadtrees-2-implementation-in-python/
    """
    ...
    def contains(self, point):
        ...
        try:
            point_x, point_y = point.get_x(), point.get_y()
